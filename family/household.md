...
|---|---|---|
| Kitchen/bath remodel — **Gomez (chosen direction)** | **Meeting 6/12 went well — proceeding with Gomez** | Design phase. **Jana** is the designer on the project (did an earlier walk-through June 3). (confirm contact details) |
| Kitchen/bath remodel — Kaufmann Company (declining) | **Sending feedback / passing** | Gomez meeting went well, so the family is letting Kaufmann know. Juliana emailed 6/12 (cc Roy) with a timeline "assuming we close next week" + insurance policy, so they're awaiting word — close the loop promptly. Contacts: Roy Kaufmann (roy@kaufmanncompany.com, cell 407-283-9332), Juliana Kaufmann (juliana@, 321-732-1303, office 407-755-1606). His last terms, for reference if revisited: 50/20/20/10 schedule, $200/day clause tied to agreed completion date, license pending (contractor would co-sign) |
