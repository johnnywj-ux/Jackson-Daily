...
| Kitchen/bath remodel — Kaufmann Company (fallback, likely declining) | **Parked, but heating up** — Juliana emailed 6/12 (cc Roy) with a project timeline "assuming we close next week" + their insurance policy; Michelle forwarded to John | Kaufmann is proceeding as if it's a go — the pass note can't wait long. Send once confident in the Gomez plan (surfaced in 6/13 briefing). Contacts: Roy Kaufmann (roy@kaufmanncompany.com, cell 407-283-9332), Juliana Kaufmann (juliana@, 321-732-1303, office 407-755-1606). His last terms, for reference if revisited: 50/20/20/10 schedule, $200/day clause tied to agreed completion date, license pending (contractor would co-sign) |
